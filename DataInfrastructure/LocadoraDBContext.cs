...
namespace DataInfrastructure
{
    public class LocadoraDBContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\entra21\Documents\LocadoraDB.mdf;Integrated Security=True;Connect Timeout=5", x => x.EnableRetryOnFailure(5));
